...
namespace Assignment_2_Spring_2022 
{
    class Program
    {
        ...
        */
        ...
        public static int SearchInsert(int[] nums, int target)
        {
            try
            {
                ...
                //This loop will add the nums1 array elements to the arraylist arr
                for (int i = 0; i < nums.Length; i++)
                {
                    arr.Add(nums[i]);
                }
                //This will add the target element entered by the user.
                //In this we have to find the index of the target element we have once inserted into the array
                arr.Add(target);
                //This will sorting the arraylist in ascending order
                arr.Sort();
                //This loop will return the index of the target element
        ...
        */
        ...
        public static string MostCommonWord(string paragraph, string[] banned)
        {
            try
            {
                ...
                //This will removing all the punctuations marks from the paragraph
                paragraph1 = Regex.Replace(paragraph1, @"[^\w\d\s]", "");

                //This will convert the pargraph to lowercase
                string wordTolowercase = paragraph1.ToLower();
                //This will store each and every word in the paragraph as an array
                string[] words = wordTolowercase.Split(" ");

                SortedDictionary<String, int> dict = new SortedDictionary<String, int>();

                //this is used to loop through the paragraph
                for (int i = 0; i < words.Length; i++)
                {

                    //this loop is used if the dictionary does not contain the word add it
                    if (dict.ContainsKey(words[i]))
                    {
                        //if the word is present it increments the count by 1 if it is match.
                        //The key is the word and the value gets stored as the sum
                        dict[words[i]] += 1;
                    }
                    else
                    {
        ...
        public static int FindLucky(int[] arr)
        {
            try
            {
                ...
                {
                    //if the dictionary contains the key we add it to the value 
                    ...
                    {
                        //if the value is not presnt add the value as
                        //corresponding to the key, which is the element of the array
                        dict.Add(arr[i], 1);
                    }
                }
        ...
        */
        ...
        public static bool IsValid(string bulls_string10)
        {
            try
            {
                ...
                //this loop will check the pattern of brackets
                //if the brackets are opening then then it will check if the brackets are closing
        ...
        */
        ...
        public static int UniqueMorseRepresentations(string[] words)
        {
            try
            {
                ...
                // This loop will first convert the each caharacter in the word to be converted and then 
                //iterate till the length of word
                //then we will search if the word is a the corresponding morse is added to the string
                for (int i = 0; i < words.Length; i++)
                {
                    if (i == words.Length)
                        break;
